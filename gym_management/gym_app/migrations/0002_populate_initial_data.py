...
def populate_initial_data(apps, schema_editor):
    ...
    HallType.objects.get_or_create(
        type="training", defaults={"type_description": "Training hall"}
    )
    HallType.objects.get_or_create(
        type="swimming", defaults={"type_description": "Swimming hall"}
    )
    ...
    Hall.objects.get_or_create(
        name="Main Hall",
        defaults={"users_capacity": 50, "hall_type_id": HallType1, "gym_id": Gym1},
    )
    Hall.objects.get_or_create(
        name="Secondary Hall",
        defaults={"users_capacity": 30, "hall_type_id": HallType1, "gym_id": Gym1},
    )
